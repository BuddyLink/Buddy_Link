...
const securityPage = () => {
  return (
    <div className="min-h-screen md:bg-green-100 sm:bg-green-300 px-4 sm:px-8 py-10 dark:bg-gray-900">
      <div className="p-4 max-w-3xl mx-auto bg-white rounded-lg shadow-md mb-4 sm:p-10 dark:bg-gray-800 dark:text-green-600">
        <h1 className="text-2xl md:text-4xl font-bold text-center mb-4 text-green-800 dark:text-emerald-300">
          Security Page
        </h1>
        <section className="mb-6 md:ml-9">
          <h2 className="text-xl md:text-2xl font-semibold flex items-center gap-2 text-gray-700 mb-2 dark:text-green-600">
            <LiaUserShieldSolid className="text-green-600" />
            General Security Tips
          </h2>
          <ul className="list-disc pl-6 text-sm text-gray-800 space-y-1 dark:text-emerald-300">
