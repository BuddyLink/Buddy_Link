      ...
      {selected && (
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md lg:px-10 lg:py-10">
          ...
          <div className="mt-4 flex justify-center gap-5">
            <Link to="/security">
              <button className="flex items-center gap-1 bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-700 transition ">
                <RiShieldUserFill />
                Sefety
              </button>
            </Link>
            ...
            <Link to="/buddy">
              <button className="flex items-center gap-1 bg-green-600 text-white px-2 py-2 rounded hover:bg-green-800 transition">
