      ...
      {selected && (
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md lg:px-10 lg:py-10">
          ...
          <div className=" text-left space-y-1 text-gray-700">
            <p>
              <span className="font-semibold"> Name: </span> {selected.name} {' '} {selected.surname}
            </p>
            <p>
              <span className="font-semibold">WalkCount: </span> {selected.walkCount}
            </p>
            <p>
              <span className="font-semibold">Preferred Contact: </span> {selected.preferredContact}
            </p>
            <p>
