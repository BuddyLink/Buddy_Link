      ...
      <div className=" w-full max-w-sm sm:max-w-md md:max-w-lg bg-white shadow-xl rounded-2xl p-6 sm:p-8 mt-15 mr-3 ml-3 ">
        <div className="text-center mb-6">
          ...
          <div className="space-y-4">
            ...
            />
            <label className="block text-left justify-left text-m font-medium text-gray-600 mb-1.5">
              Password
            </label>
            <input
              type="password"
            ...
            />
            <button
              className="w-full mt-4 bg-emerald-500 py-2 px-6 rounded-md mt-6 text-center text-m text-gray-700 trasition-transform hover:scale-90 justify-center"
              onClick={handleLogin}
            >
              Sign In
            </button>
